...
$rst_query2=mysql_query("SELECT * FROM qgc_noticia WHERE id=$id;", $conexion);
...
<div id="contenido-cuerpo">
    ...
    <div id="panel-der">
                    	<div id="item-panel-der">
                        	...
                        	<hr />
                            <p align="center">
                            <img src="imagenes/upload/<?php echo $fila_query2["imagen"] ?>" alt="<?php echo $fila_query2["titulo"] ?>" /></p>
