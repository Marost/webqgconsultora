...
if (!empty($_POST['captcha'])) {
	...
	if (empty($_SESSION['captcha']) || trim(strtolower($_POST['captcha'])) != $_SESSION['captcha']) {
		...
		mysql_query("INSERT INTO qgc_inscripcion (nombre_completo, empresa, cargo, direccion, telefono, email, mensaje) VALUES ('$nombre', '$empresa', '$cargo', '$direccion', '$telefono', '$email', '$comentario')", $conexion);
		
		//ENVIAR A CORREO ELECTRONICO
		$msg.="Inscripción de Cursos";
