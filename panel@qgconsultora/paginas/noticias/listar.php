...
header("Content-Type: text/html; charset=utf-8");
	...
	{
		$rst_query=mysql_query("SELECT * FROM qgc_noticia WHERE id>0 ORDER BY id DESC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM qgc_noticia WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM qgc_noticia WHERE titulo LIKE '%$buscar%' ORDER BY id DESC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM qgc_noticia WHERE titulo LIKE '%$buscar%' ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
...
<div id="contenido">
    <div id="titulo_principal">
      <h2>Lista - Noticias</h2></div><!-- FIN TITULO PRINCIPAL -->
    <div id="contenido_total">
        ...
        <div id="contenido">
              <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p><a href="form-agregar.php"><strong>AGREGAR NOTICIA</strong></a></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <table width="700" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="85%">
                           	  <p class="texto-azul12-Arial"><strong class="up"><?php echo stripslashes($fila["titulo"]) ?></strong></p>
                              <p>Publicado el: <strong><?php echo $fila["fecha"] ?></strong></p></td>
